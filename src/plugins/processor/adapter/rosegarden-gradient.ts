 ...
 */
class RoseGardenGradientAdapterClazz extends GradientProcessor {
  ...
  processor(chunk: Chunk, chunkIndex: number): string {
    ...
    return `<g:${pcolors.join(":")}>${textBuilder.build()}`;
  }
}

export const RoseGardenGradientAdapter: GradientProcessorConstructor = RoseGardenGradientAdapterClazz;
